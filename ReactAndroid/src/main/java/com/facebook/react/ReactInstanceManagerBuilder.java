...
public class ReactInstanceManagerBuilder {
  ...
  private JavaScriptExecutorFactory getDefaultJSExecutorFactory(
    ...
    try {
      ...
      /*If JSC fails, React was falling back on Hermes
      If Hermes is disabled, it fails and prints stacktrace for hermes 
      which was misguiding since the original JSC exception was getting gobbled
      We removed the hermes fallback and throw the actual error to debug the actual reason for linking fail
      */
